...
const EVENTS: Record<string, string[]> = {
  ...
  halloween: [
    ...
    "深いワインレッドのベルベットのマントと白い襟を自然に着た、上品で可愛いドラキュラ風のハロウィンのペットポートレートを生成してください。背景はビクトリア調の玄関先とし、彫刻したかぼちゃ、暖かなキャンドル、少量の落ち葉をバランスよく配置してください。トリックオアトリートのバケツは犬に持たせず前足の横に置いてください。犬の顔を暖かな光で明るく見せ、瞳の自然なキャッチライト、マントの布地、元の毛並みを精細に表現し、背景は柔らかくぼかしてください。人物・人の手・読める文字・数字・ロゴは入れないでください。",
  ],
  christmas: [
