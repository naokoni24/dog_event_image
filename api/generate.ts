...
const EVENTS: Record<string, string[]> = {
  ...
  imohori: [
    ...
    "青空の下に広がるさつまいも畑で、湯気の立つ大きな焼き芋を犬の少し前方の地面や葉の上に置き、少し離れた位置から興味深そうに見つめている画像を生成してください。さつまいもは犬にくわえさせたり持たせたりせず、地面に自然に置いた状態にしてください。犬の顔や焼き芋の接写にはせず、犬は画面高の約35%に収めてください。畑の畝が手前から遠くまで続き、掘り出したさつまいも、収穫かご、遠くの木々、秋晴れの空まで見える畑全体の引きの構図にしてください。",
  ],
  halloween: [
