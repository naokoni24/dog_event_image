...
const FRAMING = "全イベントで、イベント会場・風景と犬の関係が一目で分かる環境ポートレート（引きの全体構図）にしてください。犬は画面の高さの約35〜55%を目安に収め、犬だけで画面を埋めないでください。構図は犬の頭頂・耳先から胴体、そして自然に見えている足先までの全身を画面内に収め、四辺に十分な余白を残してください。衣装や姿勢で隠れている脚は無理に描き足さないでください。顔や体を大きく切り取る接写、耳・頭・胴体・見えている足先が画面外へ切れる構図は絶対に禁止です。元の写真に複数の犬がいる場合は、すべての犬の全身を画面内に収めてください。画面の少なくとも半分にはイベントの会場・装飾・小道具・情景をはっきり見せ、何のイベントかが背景だけでも一目で伝わる構図にしてください。";
...
const EVENTS: Record<string, string[]> = {
  ...
  imohori: [
    "麦わら帽子と農作業用の小さなエプロンを身につけて、畝が奥まで続くさつまいも畑で、掘り出したばかりの大きなさつまいもの横に座っている画像を生成してください。秋晴れの空、畑の畝、遠くの木々まで見渡せる引きの構図にしてください。",
    "赤いチェック柄のバンダナを首に巻いて畑の畝に立ち、地面からたった今掘り出したばかりの大きなさつまいものツルを口にくわえて引き抜いている、躍動感あふれる芋掘りの瞬間の画像を生成してください。鼻先や前足に土がついた、掘りたてらしい臨場感を出してください。犬のアップにはせず、複数の畝が手前から遠くまで続き、収穫かごや秋空も見える畑全体の引きの構図にしてください。",
    "青空の下に広がるさつまいも畑で、少し離れた地面や葉の上に置かれた湯気の立つ大きな焼き芋を、普段通りの自然な姿勢と頭の角度で座ったまま見つめて今にも食べたそうにしている画像を生成してください。頭を下げたり首を伸ばしたりして対象に顔を近づける不自然なポーズにはせず、顔と体の大きさの比率が他の犬の写真と変わらない自然なプロポーションを保ってください。さつまいもは犬にくわえさせたり持たせたりせず、地面に自然に置いた状態にしてください。犬は画面高の約35〜55%に収め、畑の畝が手前から遠くまで続き、掘り出したさつまいも、収穫かご、遠くの木々、秋晴れの空まで見える畑全体の引きの構図にしてください。",
  ],
  halloween: [
  ...
  hiroshima: [
    "世界遺産・宮島の厳島神社の朱色の大鳥居を背景に、遠浅の海岸に立ってその大鳥居を見つめている画像を生成してください。大鳥居全体と海、対岸に広がる弥山の緑まで見渡せる引きの構図にし、鳥居が背景の中でひときわ大きく目立つようにしてください。",
    "広島東洋カープを応援する雰囲気で、赤いレプリカユニフォームと、正面中央に白い縁取りの「C」のロゴマークが入った赤いメッシュ地のトラッカーキャップを自然に身につけて、鮮やかな橙色の座席がずらりと並ぶ広島の野球場のスタンドを背景に座っている画像を生成してください。まわりの観客席では、赤いメガホンを打ち鳴らし、赤い応援タオルを頭上に掲げ、たくさんの赤いジェット風船が空高く一斉に舞い上がっている、地元球団を熱く応援する賑やかな雰囲気にしてください。内野席から見渡せるグラウンドと青空まで含めた球場全体が見渡せる引きの構図にしてください。キャップの「C」ロゴ以外に、判読できる文字・チーム名・背番号・他社ロゴ・ブランド名を一切入れないでください。",
    "広島風お好み焼き店の鉄板カウンター席で、艶やかなソースを塗った円形のお好み焼きの上に、刻んだ青ねぎを頂上がこんもり山になるほどたっぷりと盛り付け、その中央に鮮やかなオレンジ色の生卵の黄身を一つ乗せた本格的な広島風お好み焼きから、白い湯気がふんわりと立ちのぼっている鉄板の手前に座っている画像を生成してください。湯気は犬の顔を隠さない程度に、焼きたてらしさが伝わる自然な量にしてください。奥には焼きそばの麺が見える鉄板も配置してください。お好み焼きは犬にくわえさせず鉄板の上に置いたままにし、コテやソースの容器、店内の暖かい照明も背景に入れてください。",
  ],
};
  ...
  for (let attempt = 1; attempt <= MAX_RETRIES; attempt++) {
    try {
      ...
      const response = await openai.images.edit({
        ...
        // 自体をサポートせず常に高忠実度で処理するため、ポーズ・構図が元写真から
        // ほぼ変わらない（元写真をそのまま貼り付けたような）問題が発生した。
