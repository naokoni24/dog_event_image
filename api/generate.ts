...
const EVENTS: Record<string, string[]> = {
  ...
  hiroshima: [
    ...
    "広島風お好み焼き店の鉄板カウンター席で、艶やかなソースを塗った円形のお好み焼きの上に、刻んだ青ねぎを頂上がこんもり山になるほどたっぷりと盛り付け、その中央に鮮やかなオレンジ色の生卵の黄身を一つ乗せた本格的な広島風お好み焼きが湯気を立てる鉄板の手前に座っている画像を生成してください。奥には焼きそばの麺が見える鉄板も配置してください。お好み焼きは犬にくわえさせず鉄板の上に置いたままにし、コテやソースの容器、店内の暖かい照明も背景に入れてください。",
  ],
};
