...
// 枚目ごとに異なる表情・雰囲気の指示
const FACE = "この犬の顔・顔の形・目の形・目の間隔・鼻の形と大きさ・口元・マズルの長さと丸み・耳の形・毛の質感と色は元の写真と完全に同一の個体を維持してください。顔まわりの毛並み、目の周りの毛、鼻周りの毛、口元の毛、耳周りの毛の長さ・カール具合・毛束感・色の濃淡を絶対に変えないでください。特に茶色のトイプードルの場合、顔の巻き毛の密度、毛色の濃淡、目鼻の位置、マズル周りの毛の形を元写真のまま厳密に維持してください。別の犬の顔、一般的なトイプードル顔、テディベア風の別顔に変えることは絶対に禁止。顔立ちを美化・若返り・補正しないでください。表情のみ少し変えることは許可します。写真に複数の犬が写っている場合は、それぞれの犬を個別の個体として認識し、各犬の顔・毛色・毛並みをそれぞれ元の写真のまま厳密に維持してください。";
