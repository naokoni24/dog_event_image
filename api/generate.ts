...
const EVENTS: Record<string, string[]> = {
  ...
  undokai: [
    "赤い鉢巻きを締めて、万国旗が飾られた運動会の校庭でハツラツと走っている画像を生成してください。",
    "白い鉢巻きを締めて、高い玉入れのカゴを見上げている画像を生成してください。足元とまわりに紅白の玉をたくさん転がし、背景には万国旗と秋晴れの青空を入れて賑やかな雰囲気にしてください。玉は犬に持たせず、口元や足元に自然に配置してください。",
    "首に文字のない金色のメダルをかけて、木製の表彰台の上に誇らしげに座っている画像を生成してください。背景には万国旗、応援の旗、白線の引かれた校庭を入れてください。メダル・表彰台・旗には読める文字・数字を一切入れないでください。",
  ],
};
