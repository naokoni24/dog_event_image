...
const EVENTS: Record<string, string[]> = {
  ...
  hiroshima: [
    ...
    "広島東洋カープを応援する雰囲気で、赤いレプリカユニフォームと、赤ヘル軍団を思わせる赤いヘルメット風の帽子を自然に身につけて、鮮やかな橙色の座席がずらりと並ぶ広島の野球場のスタンドを背景に座っている画像を生成してください。まわりの観客席では、赤いメガホンを打ち鳴らし、赤い応援タオルを頭上に掲げ、たくさんの赤いジェット風船が空高く一斉に舞い上がっている、地元球団を熱く応援する賑やかな雰囲気にしてください。内野席から見渡せるグラウンドと青空まで含めた球場全体が見渡せる引きの構図にしてください。ユニフォームやヘルメット風の帽子、メガホンには判読できるロゴ・チーム名・背番号・文字を一切入れず、無地の赤色で表現してください。",
