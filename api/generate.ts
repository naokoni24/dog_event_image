...
const EVENTS: Record<string, string[]> = {
  ...
  imohori: [
    ...
    "青空の下に広がるさつまいも畑で、湯気の立つ大きな焼き芋を犬の足元近くの地面や葉の上に置き、鼻先を自然に近づけて興味深そうに匂いを確かめている画像を生成してください。さつまいもは犬にくわえさせたり持たせたりせず、地面に自然に置いた状態にしてください。この3枚目だけは共通の犬の大きさ指定より小さくし、犬の全身を画面高の約25〜30%に収めてください。犬の顔や焼き芋の接写にはせず、畑の畝が手前から遠くまで続き、掘り出したさつまいも、収穫かご、遠くの木々、秋晴れの空まで見える畑全体の引きの構図にしてください。",
  ],
  halloween: [
