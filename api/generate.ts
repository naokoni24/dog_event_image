...
const EVENTS: Record<string, string[]> = {
  ...
  imohori: [
    ...
    "青空の下に広がる畑で、湯気の立つ大きな焼き芋を目の前の地面や葉の上に置き、鼻先を近づけて今にも食べようとしている画像を生成してください。さつまいもは犬にくわえさせたり持たせたりせず、地面に自然に置いた状態にしてください。焼き芋を見つめる、食いしん坊で愛らしい表情にしてください。畑の畝、掘り出したさつまいも、収穫かご、秋晴れの空まで見える引きの構図にしてください。",
  ],
  halloween: [
