...
const EVENTS: Record<string, string[]> = {
  ...
  hiroshima: [
    ...
    "広島東洋カープを応援する雰囲気で、赤いレプリカユニフォームを自然に着て、広島の野球場のスタンドを背景に座っている画像を生成してください。まわりに赤いメガホンを持って応援する観客席の賑わいと、内野席から見渡せるグラウンド、青空まで含めた球場全体が見渡せる引きの構図にしてください。ユニフォームやメガホンには判読できるロゴ・チーム名・背番号・文字を一切入れず、無地の赤色で表現してください。",
