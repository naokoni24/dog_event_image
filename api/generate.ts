...
const KEEPS = [
  // 1枚目：通常
  `${EDIT}${ANATOMY}犬種・毛並み・毛色・年齢感・顔立ちは完全にそのまま維持してください。${FACE}元の写真で犬が着ている服や洋服は生成画像では着せないでください。後ろ向きは禁止。全体的にかわいい雰囲気で仕上げてください。ここまでの指示は犬本体（顔・毛並み・毛色・体型）を維持するためのものです。これから指定する衣装・小道具・背景・演出は、控えめにせず必ずはっきりと分かるように反映させてください。`,
  // 2枚目：通常
  `${EDIT}${ANATOMY}犬種・毛並み・毛色・年齢感・顔立ちは完全にそのまま維持してください。${FACE}元の写真で犬が着ている服や洋服は生成画像では着せないでください。後ろ向きは禁止。全体的にかわいい雰囲気で仕上げてください。ここまでの指示は犬本体（顔・毛並み・毛色・体型）を維持するためのものです。これから指定する衣装・小道具・背景・演出は、控えめにせず必ずはっきりと分かるように反映させてください。`,
  // 3枚目：少し舌出し
  `${EDIT}${ANATOMY}犬種・毛並み・毛色・年齢感・顔立ちは完全にそのまま維持してください。${FACE}元の写真で犬が着ている服や洋服は生成画像では着せないでください。後ろ向きは禁止。口を少し開けて舌を少しだけ出した愛らしい表情にしてください。全体的にかわいい雰囲気で仕上げてください。ここまでの指示は犬本体（顔・毛並み・毛色・体型）を維持するためのものです。これから指定する衣装・小道具・背景・演出は、控えめにせず必ずはっきりと分かるように反映させてください。`,
];
...
const EVENTS: Record<string, string[]> = {
  ...
  halloween: [
    "立体感のある上質なオレンジ色のかぼちゃコスチュームを自然に着て、夕暮れのかぼちゃ畑で大小のジャック・オー・ランタンに囲まれたハロウィンのペットポートレートを生成してください。犬の頭頂・耳先から胴体と自然に見えている足先まで全身を画面内に収め、四辺に十分な余白を残してください。衣装や姿勢で隠れている脚は無理に描き足さないでください。顔や体を大きく切り取る接写、耳・頭・胴体・見えている足先が画面外へ切れる構図は禁止です。元写真に複数の犬がいる場合は、すべての犬の全身を画面内に収めてください。犬の顔を画面の主役にし、ランタンの暖かな光を正面斜めから、満月の淡い青い光を輪郭に当て、瞳の自然なキャッチライトと一本一本の毛並みが明るく精細に見えるようにしてください。背景は紺色とオレンジ色で奥行きを出し、装飾を詰め込みすぎず、読める文字・数字・ロゴは入れないでください。",
    "目や顔を隠さないサイズの魔女の三角帽子と、質感の分かる黒いベルベットのマントを自然に着たハロウィンのペットポートレートを生成してください。犬の頭頂・耳先から胴体と自然に見えている足先まで全身を画面内に収め、四辺に十分な余白を残してください。衣装や姿勢で隠れている脚は無理に描き足さないでください。顔や体を大きく切り取る接写、耳・頭・胴体・見えている足先が画面外へ切れる構図は禁止です。元写真に複数の犬がいる場合は、すべての犬の全身を画面内に収めてください。背景は西洋ゴシック様式のお化け屋敷、紫と濃紺の夜空、控えめなコウモリと蜘蛛の巣、地面付近の薄い霧にしてください。暖かな窓明かりで犬の顔と毛並みを明るく照らし、月光の縁取り光と瞳の自然なキャッチライトを加え、怖すぎず上品で可愛い映画のワンシーンのようにしてください。読める文字・数字・ロゴは入れないでください。",
    "深いワインレッドのベルベットのマントと白い襟を自然に着た、上品で可愛いドラキュラ風のハロウィンのペットポートレートを生成してください。犬の頭頂・耳先から胴体と自然に見えている足先まで全身を画面内に収め、四辺に十分な余白を残してください。衣装や姿勢で隠れている脚は無理に描き足さないでください。顔や体を大きく切り取る接写、耳・頭・胴体・見えている足先が画面外へ切れる構図は禁止です。元写真に複数の犬がいる場合は、すべての犬の全身を画面内に収めてください。背景はビクトリア調の玄関先とし、彫刻したかぼちゃ、暖かなキャンドル、少量の落ち葉をバランスよく配置してください。トリックオアトリートのバケツは犬に持たせず前足の横に置いてください。犬の顔を暖かな光で明るく見せ、瞳の自然なキャッチライト、マントの布地、元の毛並みを精細に表現し、背景は柔らかくぼかしてください。玄関脇の小さな木製看板1枚だけに、英語の「Happy Halloween」をこの綴りと大文字・小文字のまま正確に1回だけ、はっきり読めるように表示してください。それ以外の文字・数字・ロゴは入れず、人物や人の手も入れないでください。",
  ],
  christmas: [
  ...
  natsumaturi: [
    "浴衣を着て、提灯が並ぶ夏祭りの夜店でたこ焼きやりんご飴に囲まれている楽しそうな画像を生成してください。犬の頭頂・耳先から胴体と自然に見えている足先まで全身を画面内に収め、四辺に十分な余白を残してください。衣装や姿勢で隠れている脚は無理に描き足さないでください。顔や体を大きく切り取る接写、耳・頭・胴体・見えている足先が画面外へ切れる構図は禁止です。元写真に複数の犬がいる場合は、すべての犬の全身を画面内に収めてください。",
    "夏祭りの法被を着て、大きな花火が打ち上がる夜空の下で嬉しそうにしている画像を生成してください。犬の頭頂・耳先から胴体と自然に見えている足先まで全身を画面内に収め、四辺に十分な余白を残してください。衣装や姿勢で隠れている脚は無理に描き足さないでください。顔や体を大きく切り取る接写、耳・頭・胴体・見えている足先が画面外へ切れる構図は禁止です。元写真に複数の犬がいる場合は、すべての犬の全身を画面内に収めてください。",
    "金魚すくいのたらいの前で浴衣を着て夏祭りを楽しんでいるかわいい画像を生成してください。犬の頭頂・耳先から胴体と自然に見えている足先まで全身を画面内に収め、四辺に十分な余白を残してください。衣装や姿勢で隠れている脚は無理に描き足さないでください。顔や体を大きく切り取る接写、耳・頭・胴体・見えている足先が画面外へ切れる構図は禁止です。元写真に複数の犬がいる場合は、すべての犬の全身を画面内に収めてください。提灯と屋台の明かりで賑やかな雰囲気にしてください。",
  ],
  resort: [
