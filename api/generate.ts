...
const KEEPS = [
  // 1枚目：通常
  `${EDIT}犬種・毛並み・毛色・年齢感・顔立ちは完全にそのまま維持してください。${FACE}元の写真で犬が着ている服や洋服は生成画像では着せないでください。後ろ向きは禁止。全体的にかわいい雰囲気で仕上げてください。ここまでの指示は犬本体（顔・毛並み・毛色・体型）を維持するためのものです。これから指定する衣装・小道具・背景・演出は、控えめにせず必ずはっきりと分かるように反映させてください。`,
  // 2枚目：通常
  `${EDIT}犬種・毛並み・毛色・年齢感・顔立ちは完全にそのまま維持してください。${FACE}元の写真で犬が着ている服や洋服は生成画像では着せないでください。後ろ向きは禁止。全体的にかわいい雰囲気で仕上げてください。ここまでの指示は犬本体（顔・毛並み・毛色・体型）を維持するためのものです。これから指定する衣装・小道具・背景・演出は、控えめにせず必ずはっきりと分かるように反映させてください。`,
  // 3枚目：少し舌出し
  `${EDIT}犬種・毛並み・毛色・年齢感・顔立ちは完全にそのまま維持してください。${FACE}元の写真で犬が着ている服や洋服は生成画像では着せないでください。後ろ向きは禁止。口を少し開けて舌を少しだけ出した愛らしい表情にしてください。全体的にかわいい雰囲気で仕上げてください。ここまでの指示は犬本体（顔・毛並み・毛色・体型）を維持するためのものです。これから指定する衣装・小道具・背景・演出は、控えめにせず必ずはっきりと分かるように反映させてください。`,
];
