...
const EVENTS: Record<string, string[]> = {
  ...
  imohori: [
    ...
    "赤いチェック柄のバンダナを首に巻いて、後ろ足二本だけで人間のようにまっすぐ直立し、たった今掘り出した大きなさつまいもを両方の前足で人間の手のように優しく抱えて胸の高さに掲げている、ユーモラスで愛らしい芋掘りの画像を生成してください。この1枚に限り、前足を手のように使ってさつまいもを持たせる表現を明示的に許可します。前足の指・関節の数と向きは犬として不自然にならないようにしつつ、後ろ足はまっすぐ伸ばし体幹を起こして安定して立っている自然なバランスにしてください。",
